...
//        ALL_HINT_MAP.put(DecodeHintType.PURE_BARCODE, Boolean.TRUE);
    ...
    public static String syncDecodeQRCode(String picturePath) {
        return syncDecodeQRCode(CodeUtil.getDecodeAbleBitmap(picturePath));
    }
    ...
    public static String syncDecodeQRCode(Bitmap bitmap) {
        ...
        try {
            ...
            result = new MultiFormatReader().decodeWithState(new BinaryBitmap(new HybridBinarizer(source.invert())));
